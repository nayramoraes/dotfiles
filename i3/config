...
bindsym $mod+Shift+Shift+k move down
...
bar {                                                                                                              
    font pango: DaddyTimeMono Nerd Font Mono 12
    ...
    colors {                                                                                                       
       ...
       statusline #FFC0CB
       separator  #44475A
	focused_workspace  #D17489 #D17489 #F8F8F2
        active_workspace   #282A36 #44475A #F8F8F2
        inactive_workspace #BBA090 #BBA090 #040404
...
# mybinds
	...
	bindsym $mod+m exec mendeleydesktop
	bindsym $mod+Shift+n exec notion-app

# Always open some programs on specified workspace
#assign [class="^Firefox"]          $workspace1
#assign [class="^Ferdi"]            $workspace2
